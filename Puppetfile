...
mod 'theforeman/dns',                  '>= 9.5.0 < 9.6.0'
mod 'theforeman/git',                  '>= 7.2.0 < 7.3.0'
mod 'theforeman/puppetserver_foreman', '>= 2.2.0 < 2.3.0'
mod 'theforeman/tftp',                 '>= 8.0.0 < 8.1.0'
mod 'katello/candlepin',               '>= 13.1.0 < 13.2.0'
mod 'theforeman/pulpcore',             '>= 7.0.1 < 7.1.0'
mod 'katello/qpid',                    '>= 9.1.0 < 9.2.0'
mod 'theforeman/foreman',              '>= 22.0.0 < 22.1.0'
mod 'theforeman/foreman_proxy',        '>= 24.0.0 < 24.1.0'
mod 'theforeman/puppet',               '>= 16.3.0 < 16.4.0'
mod 'katello/foreman_proxy_content',   '>= 22.1.0 < 22.2.0'
mod 'katello/certs',                   '>= 16.0.0 < 16.1.0'
mod 'katello/katello',                 '>= 22.1.0 < 22.2.0'
